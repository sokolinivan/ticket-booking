...
internal sealed class PermissionConfiguration : IEntityTypeConfiguration<Permission>
{
    public void Configure(EntityTypeBuilder<Permission> builder)
    {
        ...
        builder.HasKey(permission => permission.Id).HasName(IdentityConstraintNames.PermissionsPrimaryKey);
        ...
        builder.HasIndex(permission => permission.Code).IsUnique().HasDatabaseName(IdentityConstraintNames.PermissionsCodeUniqueIndex);
        ...
        builder.HasMany(permission => permission.Roles)
            ...
            .HasConstraintName(IdentityConstraintNames.RolePermissionsPermissionForeignKey)
